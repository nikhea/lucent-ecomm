  ...
  return (
    <div className="flex min-h-[280px]">
      <Link
        ...
        className="w-[200px] bg-muted flex flex-col justify-end p-4 hover:bg-accent transition-colors"
      >
      ...
      <div className="flex-1 p-4 flex flex-col gap-4 min-w-[340px]">
        {others.length ? (
          others.map((col) => (
            <Link key={col.id} href={`/shop?collection=${col.slug}`} className="block hover:bg-accent/50 rounded-lg p-3 -m-3 transition-colors">
